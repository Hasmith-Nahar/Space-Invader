...
# Background Sound
mixer.music.load('static/images/background.wav')
mixer.music.play(-1)

# player
playerImage = pygame.image.load('static/images/spaceship.png')
player_X = 370
player_Y = 523
player_Xchange = 0
...
for num in range(no_of_invaders):
    invaderImage.append(pygame.image.load('static/images/alien.png'))
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_SPACE:
                ...
                if bullet_state == "rest":
                    ...
                    bullet_sound = mixer.Sound('static/images/bullet.wav')
                    bullet_sound.play()
        ...
        if invader_Y[i] >= 450:
            if abs(player_X - invader_X[i]) < 80:
                for j in range(no_of_invaders):
                    invader_Y[j] = 2000
                    explosion_sound = mixer.Sound('static/images/explosion.wav')
